        ...
        <div className="dashboard-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link to="/admin/events" className="admin-card group">
                    <div className="p-6 bg-slate-800 rounded-xl border border-slate-700 hover:border-pink-500 transition-all duration-300 shadow-lg hover:shadow-pink-500/10 h-full flex flex-col">
                        ...
                        <p className="text-gray-400 flex-grow">View all events, manually override statuses, and manage cancelled dates.</p>
                        <div className="mt-4 text-pink-400 font-semibold flex items-center gap-2 group-hover:translate-x-1 transition-transform">
